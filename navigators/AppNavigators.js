      ...
      <Tab.Navigator
                    ...
                    <View style={{alignItems: 'center'}}>
                      <Animated.View
                        style={{
                          ...
                          height: 29,
                          borderRadius: 10,
                          backgroundColor: 'rgba(39,64,139,.7)',
                          position: 'absolute',
                        }}></Animated.View>
                      <Ionicons
                        name="home"
        ...
        <Tab.Screen
          ...
          options={{
            ...
            //   return (
            //     // <View
            //     //   // style={true ? {...styles.tabItemActive,width:widthTab,height:(widthTab>heightTab?'108%':'104%')} : styles.tabItemInactive}
